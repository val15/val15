...
#include "../valPodSansWebKit/WidgetMedia.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WidgetMedia_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 46, 9)
    ...
    "WidgetMedia\0singSupprimer\0\0"
    "supprimerDefinitif\0supprimer"
};
...
void WidgetMedia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->singSupprimer(); break;
        case 1: _t->supprimerDefinitif(); break;
        ...
        {
            typedef void (WidgetMedia::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WidgetMedia::singSupprimer)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject WidgetMedia::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WidgetMedia.data,
      qt_meta_data_WidgetMedia,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WidgetMedia.stringdata))
...
// SIGNAL 0
void WidgetMedia::singSupprimer()
{
